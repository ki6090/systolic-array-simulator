...
This is a systolic array simulator to caculate the compuation cycle counts. This code heavily references the following SCALE-SIM paper. This code is written in C++ instead of Python which is used to simulate SCALE-SIM in different manner. 
